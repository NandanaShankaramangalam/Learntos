...
const Home = () => {
  return (
    <div className='mt-28 text-custom-blue '>
        <div className='flex flex-wrap md:flex-nowrap justify-between'>
            <div className='w-full'>
               <div className='text-3xl md:text-4xl font-bold text-center pt-2 md:pt-20'>
                 <h1>Learn From the Masters</h1>
                 <p className='text-base md:text-lg font-light text-gray-600'>Learntos can help you advance your IT career!</p>
               </div>  
               <div className='flex justify-center px-6'>  
                <div id="search-bar" class="w-96 mt-8 md:mt-12 rounded-md shadow-lg z-10 bg-white">
